...
best_for:
  - "Early discovery when you need structured user understanding before committing to a problem statement or solution direction"
  - "Validating or replacing persona assumptions with observed behavior before writing PRD requirements"
  - "Preparing for user interviews by defining what activities, insights, and needs to probe per persona"
  - "Aligning a cross-functional team on who the real user is when stakeholders hold conflicting user models"
  - "Building the evidence base for Jobs-to-be-Done framing ahead of roadmap or OKR planning"
sources:
...
1. Identify an initial set of ideal users in the P block, perhaps using the Personas tool as a source of inputs.
2. Observe and/or interview the users to answer the questions identified in the A, I, and N blocks in the PAINstorming table.
3. Use this data to ensure that any proposed products, services, or interventions are aligned with actual user preferences.
...
| Source | [itk.mitre.org](https://itk.mitre.org/toolkit-tools/painstorming/) |
