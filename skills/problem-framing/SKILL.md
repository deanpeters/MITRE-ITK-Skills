...
best_for:
  - "Early discovery when the problem space is ambiguous and stakeholders disagree on what to build first"
  - "Reframing a vague executive mandate or feature request into a validated, solvable problem statement"
  - "Kicking off a new initiative where the team risks jumping to solutions before understanding root causes"
  - "Aligning cross-functional partners with conflicting priorities around a shared definition of the problem"
  - "Periodic checkpoints to verify the team is still solving the right problem as understanding evolves"
sources:
