...
`streamlit_app.py` is a browser-based explorer for the full skill library. It lets you walk the Adaptive Decision Ladder to find the right tool for your situation, or browse all 27 tools directly. Once you've picked a tool, enter your project context and get a tailored facilitation guide generated by Claude.
...
Add your Anthropic API key in the sidebar when the app opens. The ADL and browse flows work without a key; the facilitation guide generator requires one.
